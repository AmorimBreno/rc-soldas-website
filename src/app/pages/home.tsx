...
export function Home() {
  ...
  return (
    ...
    >
      <div className="flex h-screen w-full flex-col items-start justify-center px-[32px]">
      ...
      <div className="mt-[32px] flex h-screen w-full flex-col items-center justify-start px-[32px]">
      ...
      <div className="mt-[32px] flex h-screen w-full flex-row items-center justify-start gap-[64px] bg-white px-[32px] pb-[16px] pt-[96px]">
        <div className="flex h-full w-full flex-col gap-[64px]">
          ...
          <p className="text-[16px] text-black">
            Nossas soluções em soldagem foram desenvolvidas para atender aos
            mais altos padrões de qualidade e segurança em diversos segmentos
            industriais. Trabalhamos com processos precisos e materiais
            adequados a cada aplicação. <br />
            <br />
        ...
        <div className="flex h-full w-full items-center justify-center rounded-[4px] bg-blue-800"></div>
      </div>
